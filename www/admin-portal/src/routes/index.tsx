import {
  Button, DatePickerDemo, Dialog, DialogContent,
  DialogDescription,
  DialogHeader,
  DialogTitle,
  DialogTrigger,
...
export const Route = createFileRoute('/')({
  component: () => <div className='flex flex-col gap-5 justify-center items-center min-h-screen'>
    ...
    <div className='mx-60 my-16 p-7 border border-black rounded-xl'>
      ...
      <h1 className='my-5 font-bold text-xl'>This is Card</h1>
      <Card>
        <CardHeader>
      ...
      <h1 className='my-5 font-bold text-xl'>This is Carousel</h1>
      ...
      <h1 className='my-5 font-bold text-xl'>This is Checkbox</h1>
      ...
      <h1 className='my-5 font-bold text-xl'>This is Calendar</h1>
      <CalendarDemo />
      <h1 className='my-5 font-bold text-xl'>This is Progress</h1>
      <Progress value={33} />
    </div>
